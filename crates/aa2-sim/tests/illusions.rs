...
fn spirit_lance_ability() -> AbilityDef {
    AbilityDef {
        ...
        effect_specs: Some(vec![aa2_data::EffectSpec {
            ...
            payload: vec![
                aa2_data::Payload::Damage { kind: DamageType::Magical, base: vec![100.0, 160.0, 280.0, 280.0, 280.0, 280.0, 280.0, 280.0, 280.0] },
                aa2_data::Payload::ApplyBuff(Box::new(aa2_data::BuffDef {
                    name: "spirit_lance_slow".to_string(),
                    duration: vec![3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0],
                    status: aa2_data::StatusFlags::default(),
                    stat_modifier: Some(aa2_data::StatModifierSpec {
                        bonus_move_speed: vec![14.0, 21.0, 35.0, 35.0, 35.0, 35.0, 35.0, 35.0, 35.0],
                        ..Default::default()
                    }),
                    tick_effect: None,
                ...
                aa2_data::Payload::Spawn {
                    damage_dealt: vec![0.20, 0.20, 0.20, 0.20, 0.20, 0.60, 0.60, 0.60, 0.60],
                    damage_taken: 4.0,
                    duration: vec![3.5, 5.0, 8.0, 8.0, 8.0, 8.0, 8.0, 8.0, 8.0],
                },
            ],
